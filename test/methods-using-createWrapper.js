...
describe('methods using `createWrapper`', () => {
  ...
  it('should work when hot', () => {
    lodashStable.times(2, (index) => {
      ...
      let actual = last(lodashStable.times(HOT_COUNT, () => {
      ...
      actual = last(lodashStable.times(HOT_COUNT, () => {
        let bound1 = index ? bind(fn, object, 1) : bind(fn, object),
